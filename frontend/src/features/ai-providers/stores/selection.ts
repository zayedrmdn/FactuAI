 ...
 * Colocated from src/stores/ai-store.ts as part of feature-centric architecture.
 *
 * Usage:
 * ```tsx
...
import type { AIStore, AIModelSelection, ModelConfig } from '../types';
import { modelRegistry, getModelById, getProvider, isValidSelection } from '../registry';
