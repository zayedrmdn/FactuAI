...
const openRouterModels: ModelConfig[] = [
  // DEFAULT MODEL - Llama 3.3 70B
  {
    ...
    description:
      'NEW DEFAULT: Superior reasoning at low cost ($0.10/M input). 131K context window.',
  ...
  },
  {
    ...
    description: 'Free tier of Llama 3.3 70B. High quality reasoning with zero cost.',
  ...
  // GPT-4o-mini - Recommended for structured output tasks (extraction, strategist, pivot)
  {
    ...
    description:
      'Fast, affordable OpenAI model with excellent structured output support. Ideal for extraction/strategist phases.',
    defaultTemperature: 0.1,
    defaultMaxTokens: 4096,
    defaultTopP: 0.9,
    defaultSystemPrompt: SYSTEM_PROMPTS.FACTCHECK,
  ...
  },
  {
    ...
    description:
      'Excellent reasoning, 160K+ context, reliable performance (Recommended for verification)',
    defaultTemperature: 0.3,
    defaultMaxTokens: 2048,
    defaultTopP: 0.9,
    defaultSystemPrompt: SYSTEM_PROMPTS.FACTCHECK,
  ...
  },
  {
    ...
    description:
      'Fast, reliable MoE model with agent-centric design (Recommended for intent detection)',
    defaultTemperature: 0.3,
    defaultMaxTokens: 1024,
    defaultTopP: 0.9,
    defaultSystemPrompt: SYSTEM_PROMPTS.FACTCHECK,
  ...
  },
  {
    ...
    description:
      'Multimodal vision model - Frequently rate-limited, no system message support (Use for image analysis only)',
    defaultTemperature: 0.3,
    defaultMaxTokens: 1024,
    defaultTopP: 0.9,
    defaultSystemPrompt: SYSTEM_PROMPTS.GENERAL,
  ...
  },
  {
    ...
    description:
      'High-performing, industry-standard 7.3B parameter model optimized for speed and context (Free tier)',
    defaultTemperature: 0.1,
    defaultMaxTokens: 1024,
    defaultTopP: 0.9,
    defaultSystemPrompt: SYSTEM_PROMPTS.FACTCHECK,
