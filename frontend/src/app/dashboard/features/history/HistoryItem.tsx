        ...
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between mb-1">
              ...
              {assessment && (
                <span className={`text-[10px] uppercase tracking-wider font-bold px-1.5 py-0.5 rounded border ${assessment.color}`}>
                  {assessment.label}
                </span>
              )}
            </div>
          ...
          <div className="border-t border-border/50 pt-3 mt-1 space-y-3">
            ...
            <div className="flex gap-4 text-xs text-muted-foreground">
              <span className="flex items-center gap-1">
                <span className="font-semibold text-foreground">{item.results?.length || 0}</span> Claims
              </span>
