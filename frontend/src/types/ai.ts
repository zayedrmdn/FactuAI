/**
 * AI Model Registry Type Definitions
 *
 * This file defines the strict TypeScript interfaces for the AI provider
 * and model configuration system. All AI-related type definitions must
 * be added here to maintain type safety across the application.
 */
