      ...
      <div className="container mx-auto px-6 text-center">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <p className="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed">
            Register for free and start fact-checking instantly. 
            Join researchers, journalists, and truth-seekers who trust FactuAI.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Link href="/login">
              <button 
                className="w-full sm:w-auto text-lg px-8 py-4 h-12 rounded-md font-medium text-white border-2 border-white bg-transparent hover:bg-white hover:text-blue-600 transition-all duration-200 inline-flex items-center justify-center gap-2"
              >
