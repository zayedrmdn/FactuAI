...
const openRouterModels: ModelConfig[] = [
  ...
  },
  {
    ...
    description: 'MoE assembly with strong reasoning, 160K+ context (Free tier)',
    defaultTemperature: 0.7,
    defaultMaxTokens: 1024,
    defaultTopP: 0.9,
    defaultSystemPrompt: RESEARCH_SYSTEM_PROMPT,
  ...
  },
  {
    ...
    description: 'MoE model with hybrid inference modes, agent-centric design (Free tier)',
    defaultTemperature: 0.7,
    defaultMaxTokens: 1024,
    defaultTopP: 0.9,
    defaultSystemPrompt: GENERAL_SYSTEM_PROMPT,
  ...
  },
  {
    ...
    description: 'Multimodal model with vision, multilingual support (Free tier)',
    defaultTemperature: 0.3,
    defaultMaxTokens: 1024,
    defaultTopP: 0.9,
    defaultSystemPrompt: GENERAL_SYSTEM_PROMPT,
